            ...
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <section className="space-y-6">
                    ...
                    <div className="pl-4 text-zinc-400">
                        <p>Mr. Anfield Football is an independent, unofficial fan publication. We are not affiliated with, endorsed by, or connected to Liverpool Football Club or the Premier League. All opinions expressed are those of the individual contributors.</p>
                    </div>
                </section>
                ...
                <section className="space-y-6">
                    ...
                    <p>The text and original tactical analysis on this site are the property of Mr. Anfield Football. While we discuss public domain football news and statistics, unauthorized reproduction of our editorial content is strictly prohibited.</p>
                </section>
                ...
                <section className="space-y-6 text-zinc-500 text-sm border-t border-white/5 pt-12 italic">
                    <p>By using this platform, you agree to these terms. Mr. Anfield Football reserves the right to modify content or access at any time to preserve the community atmosphere. YNWA.</p>
                </section>
            </div>
        </div>
    );
